# oss-audit-24BCG10140
OSS Capstone Project - LibreOffice Audit | VIT Bhopal | 24BCG10140
...
|---|---|
| **Name** | YASH BURAD |
| **Registration Number** | 24BCG10140 |
| **University** | VIT Bhopal University |
| **Faculty** | VIKAS PANTHI |
...
```bash
git clone https://github.com/yashwantraj/oss-audit-24BCG10140.git
cd oss-audit-24BCG10140
```
...
├── OSS_Capstone_YashBurad_24BCG10140.docx  # Full project report
└── README.md                   # This file
```
...
VIT Bhopal University | Faculty: VIKAS PANTHI
